...
class PetSnackItemTemplate : public WizItemTemplate {
public:
    ...
    PetStatModificationSet getStatModifierSet() { // Property Generated Getter
      return *reinterpret_cast<PetStatModificationSet*>(reinterpret_cast<uintptr_t>(this) + 0x208);
    }

    void setStatModifierSet(PetStatModificationSet val) { // Property Generated Setter
      *reinterpret_cast<PetStatModificationSet*>(reinterpret_cast<uintptr_t>(this) + 0x208) = val;
    }
