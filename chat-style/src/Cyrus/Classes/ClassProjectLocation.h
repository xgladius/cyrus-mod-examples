...
class ClassProjectLocation : public PropertyClass {
public:
    int getCheckpointLevel() { // Property Generated Getter
      return *reinterpret_cast<int*>(reinterpret_cast<uintptr_t>(this) + 0x48);
    }

    void setCheckpointLevel(int val) { // Property Generated Setter
    ...
    std::string getDestinationLoc() { // Property Generated Getter
      return *reinterpret_cast<std::string*>(reinterpret_cast<uintptr_t>(this) + 0x70);
    }

    void setDestinationLoc(std::string val) { // Property Generated Setter
