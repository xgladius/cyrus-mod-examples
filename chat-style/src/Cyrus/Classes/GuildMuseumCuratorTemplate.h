...
class GuildMuseumCuratorTemplate : public BehaviorTemplate {
public:
    ...
    std::string getExhibit() { // Property Generated Getter
      return *reinterpret_cast<std::string*>(reinterpret_cast<uintptr_t>(this) + 0x98);
    }

    void setExhibit(std::string val) { // Property Generated Setter
