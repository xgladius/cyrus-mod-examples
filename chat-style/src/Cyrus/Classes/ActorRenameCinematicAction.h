...
class ActorRenameCinematicAction : public ActorCinematicAction {
public:
    std::string getNewNamePattern() { // Property Generated Getter
      return *reinterpret_cast<std::string*>(reinterpret_cast<uintptr_t>(this) + 0x78);
    }

    void setNewNamePattern(std::string val) { // Property Generated Setter
      *reinterpret_cast<std::string*>(reinterpret_cast<uintptr_t>(this) + 0x78) = val;
    }

    bool getBActOnlyOnFirstActor() { // Property Generated Getter
      return *reinterpret_cast<bool*>(reinterpret_cast<uintptr_t>(this) + 0x98);
    }

    void setBActOnlyOnFirstActor(bool val) { // Property Generated Setter
