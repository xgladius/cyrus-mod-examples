...
class MinigameSigilOptionMonthlyGauntletFields : public PropertyClass {
public:
    unsigned int getClassProjectID() { // Property Generated Getter
      return *reinterpret_cast<unsigned int*>(reinterpret_cast<uintptr_t>(this) + 0x48);
    }

    void setClassProjectID(unsigned int val) { // Property Generated Setter
