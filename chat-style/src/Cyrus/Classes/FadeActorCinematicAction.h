...
class FadeActorCinematicAction : public ActorCinematicAction {
public:
    ...
    float getAlphaTarget() { // Property Generated Getter
      return *reinterpret_cast<float*>(reinterpret_cast<uintptr_t>(this) + 0x7C);
    }

    void setAlphaTarget(float val) { // Property Generated Setter
