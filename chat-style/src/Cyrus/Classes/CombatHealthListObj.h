...
class CombatHealthListObj : public PropertyClass {
public:
    List<ParticipantParameter> getHealthList() { // Property Generated Getter
      return *reinterpret_cast<List<ParticipantParameter>*>(reinterpret_cast<uintptr_t>(this) + 0x48);
    }

    void setHealthList(List<ParticipantParameter> val) { // Property Generated Setter
