...
class TieredSpellRetiredSpellData : public PropertyClass {
public:
    ...
    int getTotalShardsToUpgrade() { // Property Generated Getter
      return *reinterpret_cast<int*>(reinterpret_cast<uintptr_t>(this) + 0x6C);
    }

    void setTotalShardsToUpgrade(int val) { // Property Generated Setter
