...
class DaysSinceItemPurchased : public PropertyClass {
public:
    ...
    int getDaysSinceItemPurchased() { // Property Generated Getter
      return *reinterpret_cast<int*>(reinterpret_cast<uintptr_t>(this) + 0x4C);
    }

    void setDaysSinceItemPurchased(int val) { // Property Generated Setter
