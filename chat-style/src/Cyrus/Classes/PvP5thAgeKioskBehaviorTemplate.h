...
class PvP5thAgeKioskBehaviorTemplate : public BehaviorTemplate {
public:
    std::string getKioskName() { // Property Generated Getter
      return *reinterpret_cast<std::string*>(reinterpret_cast<uintptr_t>(this) + 0x78);
    }

    void setKioskName(std::string val) { // Property Generated Setter
