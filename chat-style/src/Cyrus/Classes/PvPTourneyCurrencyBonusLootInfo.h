...
class PvPTourneyCurrencyBonusLootInfo : public LootInfo {
public:
    int getPvpTourneyCurrencyBonusAmount() { // Property Generated Getter
      return *reinterpret_cast<int*>(reinterpret_cast<uintptr_t>(this) + 0x50);
    }

    void setPvpTourneyCurrencyBonusAmount(int val) { // Property Generated Setter
