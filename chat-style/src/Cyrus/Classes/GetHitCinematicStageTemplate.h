...
class GetHitCinematicStageTemplate : public CinematicStageTemplate {
public:
    ...
    bool getBUsesGetHitSound() { // Property Generated Getter
      return *reinterpret_cast<bool*>(reinterpret_cast<uintptr_t>(this) + 0xE8);
    }

    void setBUsesGetHitSound(bool val) { // Property Generated Setter
