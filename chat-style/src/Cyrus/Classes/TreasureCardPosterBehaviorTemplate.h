...
class TreasureCardPosterBehaviorTemplate : public BehaviorTemplate {
public:
    ...
    std::string getAlternateAssetName() { // Property Generated Getter
      return *reinterpret_cast<std::string*>(reinterpret_cast<uintptr_t>(this) + 0x98);
    }

    void setAlternateAssetName(std::string val) { // Property Generated Setter
