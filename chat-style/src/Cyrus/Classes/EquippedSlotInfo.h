...
class EquippedSlotInfo : public PropertyClass {
public:
    ...
    unsigned int getItemSlotNameID() { // Property Generated Getter
      return *reinterpret_cast<unsigned int*>(reinterpret_cast<uintptr_t>(this) + 0x50);
    }

    void setItemSlotNameID(unsigned int val) { // Property Generated Setter
