...
class UserAnimationEvent : public PropertyClass {
public:
    ...
    std::string getActionType() { // Property Generated Getter
      return *reinterpret_cast<std::string*>(reinterpret_cast<uintptr_t>(this) + 0x70);
    }

    void setActionType(std::string val) { // Property Generated Setter
